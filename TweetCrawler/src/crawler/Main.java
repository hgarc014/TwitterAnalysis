...
public class Main extends Thread {
	...
	public static void main(String[] args) throws IOException,
		...
		if (args.length < 3) {
			...
			System.out
					.println("<Max Tweets> <File Sizes (MB)>  <Output Directory>");
			System.out.println("OR...\n<Max Tweets> <File Sizes (MB)>  <Output Directory> <save Every # Tweets>");
			return;
		}
...
//		threads = checkNumber(args[2], "Threads");
		...
		if (args.length > 3)
			saveEvery = checkNumber(args[3], "Check Every # Tweets");
